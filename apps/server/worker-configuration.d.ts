/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env staging` (hash: 84c9867815ec146ae9d69be6614c8341)
// Runtime types generated with workerd@1.20250508.0 2025-03-15 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		CLIENT_URL: "http://localhost:5173/" | "https://azumi.com.ng";
		CORS_ORIGIN: string;
		...
		DATABASE_URL: string;
		ORDER_NOTIFICATION: DurableObjectNamespace<import("./src/index").OrderNotification>;
		RIDER_DISPATCH: DurableObjectNamespace<import("./src/index").RiderDispatch>;
		BUCKET: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLIENT_URL" | "CORS_ORIGIN" | "PAYSTACK_SECRET_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "R2_PUBLIC_URL" | "NODE_ENV" | "BASE_URL" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_STAGING_DATABASE_ID" | "CLOUDFLARE_DATABASE_ID" | "TERMII_API_KEY" | "TERMII_SECRET_KEY" | "TERMII_BASE_URL" | "RIDER_COMMISSION_RATE" | "FIREBASE_PROJECT_ID" | "FIREBASE_CLIENT_EMAIL" | "FIREBASE_PRIVATE_KEY" | "DATABASE_URL">> {}
}
