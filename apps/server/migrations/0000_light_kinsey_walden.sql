...
CREATE TABLE `cart_item_options` (
	...
	FOREIGN KEY (`option_id`) REFERENCES `menuOption`(`id`) ON UPDATE no action ON DELETE cascade,
...
CREATE TABLE `orderItemOption` (
	...
	FOREIGN KEY (`option_id`) REFERENCES `menuOption`(`id`) ON UPDATE no action ON DELETE no action,
