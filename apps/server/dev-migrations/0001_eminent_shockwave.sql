...
INSERT INTO `__new_invitation`("id", "organization_id", "email", "role", "status", "expires_at", "inviter_id") SELECT "id", "organization_id_love", "email", "role", "status", "expires_at", "inviter_id" FROM `invitation`;--> statement-breakpoint
