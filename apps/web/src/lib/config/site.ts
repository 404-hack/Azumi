export const siteConfig = {
	title: 'Azumi: Fast & Reliable Food Delivery Across Nigeria',
	description:
		'Your fast and reliable food delivery service across Nigeria. Order from a wide selection of local restaurants and enjoy convenient delivery to your doorstep',
	url: 'https://azumi.com.ng',
	twitterUrl: 'https://twitter.com/AzumiLogistics',
	facebookUrl: '',
